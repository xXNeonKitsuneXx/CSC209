...
public class Data {
    ...
    public void selectionSort() {
        //Select the smallest first and keep do it
        for (int i = 0; i < size - 1; i++) { //Not need to check last smallest number
            int smallestIndex = i;
    ...
    public void quickSort(int first, int last) {
        ...
        while (lower <= upper) {
            while (lower <= last && info[lower] < pivot) {
                //search info that is bigger than pivot
                lower++;
            }
            //////////////////////////////////////////////////////////
    ...
    public void radixSort() {
        ...
        for (int i = 0; i < digits; factor *= radix, i++) {
            //add each number into[j] into the correct queue j
